...
@section('content')
    <div class="row">
          ...
          <div class="col-12">
            <h4 class="card-title">{{ __('Gestion de Docentes') }}</h4>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body" style="padding-bottom: 60px; padding-top: 30px;">
              <form>
                ...
                <div class="row form-group col-auto col-12" style="height: 25px;">
                    <label for="recipient-name" class="col-form-label col-6 "style="padding-left: 0px ">Domicilio</label>
                    
                  </div>
                  <div class="row col-12">
                    <input type="text" class=" col-12 form-control" id="recipient-name">
                ...
                <div class="row col-12" style="top: 20px;" >
                    <select class="col-12 custom-select" id="inputGroupSelect04" style="color:#525f7f;left: 0px;top: 15px;width: 432px;padding-right: 0px;">
                        <option selected>Departamento</option>
                        <option value="1">One</option>
                        <option value="2">Two</option>
                        <option value="3">Three</option>
