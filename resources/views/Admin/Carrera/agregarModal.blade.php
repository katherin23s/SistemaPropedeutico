...
<script>
    function agregarCarrera(nombre, direccion, correo, 
    telefono, departamento_id){
        $.ajax({
    ...
    $(document).ready(function(){
        ...
        $("#agregar-plantel").click(function(){
          //obtener valores de los inputs
            ...
            var departamento_id = 1;

            agregarCarrera(nombre, direccion, correo, telefono, departamento_id);
