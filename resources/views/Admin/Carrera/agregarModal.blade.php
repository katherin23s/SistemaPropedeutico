        ...
        <div class="modal-body" style="padding-bottom: 60px; padding-top: 30px;">
            ...
            <div class="form-group {{ $errors->has('numero-serie') ? ' has-danger' : '' }}">
                <div class="input-group input-group-alternative">
                    ...
                    <input type="text" name="numero-serie" id="input-numero-serie" class="form-control {{ $errors->has('numero-serie') ? ' is-invalid' : '' }}" 
    ...
    $(document).ready(function(){
        ...
        $("#agregar_carrera").click(function(){
          //obtener valores de los inputs
            ...
            var numero_serie = document.getElementById("input-numero-serie").value;
